...
// UAC1 audio function for the DualSense PS5 personality: control, speaker/haptics streaming and mic streaming
// interfaces, registered with USBDevice as one object.
